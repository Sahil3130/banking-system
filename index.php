...
BASIC BANKING SYSTEM</h1>
<div class="align1">
<h1 class="text-center "> Some Features Of My Banking Website</h1>

<h2 class="text-center"> TRANSFER YOUR MONEY SAFELY !!</h2>
<p class="text-center">1. You can go to 'view all customers' tab and </p>
